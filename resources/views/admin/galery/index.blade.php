...
<!-- Main content -->
 ...
 <div class="card">
        ...
        <a class="btn btn-success btn-sm" href="{{ route('galery.create')}}">
                  ...
                  <tr>
                     ...
                     <td>
                      ...
                      <td class="project-actions text-right">
                          ...
                          <a class="btn btn-info btn-sm" href="{{ route('galery.edit', $image['id'])}}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Редактировать
                          </a>
                          <form action="{{route('galery.destroy', $image['id'])}}" method="POST" style="display:inline-block;">
                             @csrf
                             @method('DELETE')
