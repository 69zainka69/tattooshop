...
<p style="color:red;">Внимание!!! Не оставляйте пустые, не заполненные поля. Даже если цена не поменялась то при обновлении цены заполните поле!!! <br>
Дробную цену Выставлять через точку . Не через запятую, а через ТОЧКУ!!!!
Каждый раз Вы добавляете цену только для одной выбранно вами валюты, Всего валют 4 на данный момент.
</p>
